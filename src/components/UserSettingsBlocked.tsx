...
import {BlockDTO, Column, ImageObject, Toast} from "@/types/types";
...
const UserSettingsBlocked: NextPage = () => {
        ...
        switch (response.status) {
            ...
            default:
                const couldnotUnblockToast: Toast = {
                    ...
                    description: "User may already unblocked or it has never been blocked.",
                    danger: "warning"
                };
    ...
    const handleUnblockMass = async () => {
        ...
        if (usernamesToUnblock.length === 0) {
            const noUserToUnblock: Toast = {title: "You did not select any user to unblock.", color: "warning"}
            ...
            switch (response.status) {
                ...
                case NOT_FOUND_RESPONSE_CODE:
                    ...
                    const someUsersNotFoundToast: Toast = {
                        ...
                        description: "Some users might deleted their account or you have already unblocked them.",
                        color: "warning"
                    }
