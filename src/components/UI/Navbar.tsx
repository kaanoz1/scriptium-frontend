                    ...
                    <div>
                            ...
                            <Dropdown placement="bottom-end">
                                ...
                                <DropdownMenu aria-label="Profile Actions" variant="flat">
                                    ...
                                    >
                                        ...
                                        >
                                            <LuUser
                                                className="text-xl text-default-500 flex-shrink-0 group-hover:text-primary"/>
                        ...
                        Savings
                                    ...
                                    >
                                        ...
                                        >
                                            <HiOutlineCog
                                                className="text-xl text-default-500 flex-shrink-0 group-hover:text-primary-500"/>
                                    ...
                                    >
                                        ...
                                        >
                                            <HiOutlineExclamation
                                                className="text-xl text-default-500 flex-shrink-0 group-hover:text-warning-500"/>
                        ...
                        Report an Issue
                                    ...
                                    >
                                        <div
                                            className="flex items-center w-full h-full px-3 py-2 gap-2 cursor-pointer group-hover:no-underline">
                                            <MdLogout
                                                className="text-xl text-default-500 flex-shrink-0 group-hover:text-red-500"/>
