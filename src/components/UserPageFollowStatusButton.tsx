...
const UserPageFollowStatusButton: NextPage<Props> = ({
    ...
    switch (userInspected.followStatusUserInspected) {
        case "Accepted":
            return (
                <div
                    className="flex items-center justify-between w-full transition-colors duration-200 cursor-pointer px-2 py-1 rounded-md border border-transparent hover:border-green-500 hover:text-green-500 hover:bg-green-50 group text-sm">
        ...
        case "Pending":
            return (
                <div
                    className="flex flex-row items-center justify-between w-full gap-4 transition-colors duration-200 cursor-pointer px-2 py-1 rounded-md border border-transparent hover:border-yellow-500 hover:text-yellow-500 hover:bg-yellow-50 dark:hover:bg-yellow-950 group">
