...
export class TranslationSearchAlgorithm extends SearchAlgorithm {
  ...
  private _methodology: TranslationSearchMethodology =
    TranslationSearchMethodology.TextSearch;
  private _emphasize: boolean = true;
  private _filterSameVerse: boolean = true;
  ...
  private constructor() {
    ...
    makeObservable<
      ...
      "_methodology" | "_emphasize" | "_filterSameVerse"
    >(this, {
