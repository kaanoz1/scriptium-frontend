            ...
            <div className="space-y-2 pt-1">
              ...
              <div className="grid grid-cols-[1fr_auto] items-center gap-2 text-xs">
                ...
                <span className="text-muted-foreground">
                  {t("ExampleDescriptions.Surah")} 1,{" "}
                  {t("ExampleDescriptions.Verse")} 5
                </span>
                ...
                <span className="text-muted-foreground">
                  {t("ExampleDescriptions.Surah")} 2,{" "}
                  {t("ExampleDescriptions.Verse")} 282
                </span>
                ...
                <span className="text-muted-foreground">
                  {t("ExampleDescriptions.GoesToSurah")} 19
                </span>
              </div>
            </div>
