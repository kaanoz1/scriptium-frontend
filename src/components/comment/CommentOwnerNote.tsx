...
import { CommentOwnerNote as CommentOwnerNoteClass } from "@/types/classes/model/Comment/Comment";

interface Props {
  comment: CommentOwnerNoteClass;
  showVerse?: boolean;
  toggleLike: () => Promise<void>;
}

const CommentOwnerNote: FC<Props> = ({
  comment,
  showVerse = false,
  toggleLike,
}) => {
...
export default CommentOwnerNote;
