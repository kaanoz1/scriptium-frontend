...
const Footer = () => {
  ...
  return (
    <footer className="w-full border-t border-border/40 bg-background/95 mt-auto flex justify-center items-center">
      <div className="container mx-auto px-4 md:px-8 lg:px-16 py-6 flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="flex flex-col md:flex-row items-center gap-4">
          {!isHomePage && (
            <LoadingLink href="/en" className="flex items-center gap-2 group">
              <Image
        ...
        <div className="flex items-center gap-5">
          <Link
            href="mailto:contact@scriptium.org"
          ...
          <Link
            href="https://instagram.com/scriptium_en"
            target="_blank"
          ...
          <Link
            href="https://github.com/scriptium-project"
            target="_blank"
            className="text-muted-foreground transition-all hover:text-foreground hover:scale-110"
          >
