...
import {T_OriginalScriptureTextFont, T_OriginalScriptureTextVariationKey, T_ScriptureCode} from "@/types/types";
...
export const useScripturePreferences = (code?: T_ScriptureCode) => {
    ...
    const setShowTranslations = (boolean: boolean) => {
        setPreferences(prev => ({
            ...prev,
            [code]: prev[code].setOptionsAndClone(prev[code].getOptions().setShowTranslationAndGetClone(boolean)),
        }));
    };
    ...
    const setShowTransliterations = (boolean: boolean) => {
        setPreferences(prev => ({
            ...prev,
            [code]: prev[code].setOptionsAndClone(prev[code].getOptions().setShowTransliterationAndGetClone(boolean)),
        }));
    }
    ...
    const setShowOriginalText = (boolean: boolean) => {
        setPreferences(prev => ({
            ...prev,
            [code]: prev[code].setOptionsAndClone(prev[code].getOptions().setShowOriginalTextAndGetClone(boolean)),
        }));
    }
    ...
    const setShowFootnotes = (boolean: boolean) => {
        setPreferences(prev => ({
            ...prev,
            [code]: prev[code].setOptionsAndClone(prev[code].getOptions().setShowFootnotesAndGetClone(boolean)),
        }));
    }

    const setOriginalTextVariation = (variation: T_OriginalScriptureTextVariationKey) => {
        setPreferences(prev => ({
            ...prev,
            [code]: prev[code].setOptionsAndClone(prev[code].getOptions().setVariationAndGetClone(variation)),
        }));
    }
