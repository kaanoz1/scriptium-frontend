...
const SignInForm: FC = () => {
  ...
  // const { isUserLoading, fetchUser } = useUser(); // This context is currently disabled and not in use since this project does not have adequate financial resources to afford legal processes to store, maintain and protect user data.
    ...
    <div className="h-[calc(100vh-130px)] flex justify-center items-center bg-gray-50 dark:bg-dark px-4 space-y-28">
      ...
      >
        <motion.h2
          ...
          exit={{ x: "50%", opacity: 0 }}
          transition={{
            opacity: { type: "inertia", duration: 0.4 },
            type: "tween",
            ease: "easeInOut",
          }}
        >
