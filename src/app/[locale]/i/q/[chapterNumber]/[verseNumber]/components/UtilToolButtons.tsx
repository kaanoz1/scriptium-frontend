...
import AudioPlayButton
    from "@/app/[locale]/i/q/[chapterNumber]/[verseNumber]/components/UtilToolButtons/AudioPlayButton";
...
import QuranTranslationChangeButton
    from "@/app/[locale]/i/q/[chapterNumber]/[verseNumber]/components/UtilToolButtons/QuranTranslationChangeButton";
import QuranConfigurationButton
    from "@/app/[locale]/i/q/[chapterNumber]/[verseNumber]/components/UtilToolButtons/QuranConfigurationButton";
import PreviousVerseButton
    from "@/app/[locale]/i/q/[chapterNumber]/[verseNumber]/components/UtilToolButtons/PreviousVerseButton";
import NextVerseButton
    from "@/app/[locale]/i/q/[chapterNumber]/[verseNumber]/components/UtilToolButtons/NextVerseButton";
...
const UtilToolButtons: React.FC<Props> = observer(({verse}) => {
    ...
    return (
        <aside
            className="flex w-full sm:w-auto items-center justify-between sm:justify-end gap-1 sm:gap-2 rounded-full px-2 py-1">
            <AudioPlayButton/>
