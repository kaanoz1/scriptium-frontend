...
const NextVerseButton: React.FC<Props> = ({ verse }) => {
  ...
  const t = useTranslations(
    "Pages.Islam.Quran.Chapter.Verse.Components.UtilToolButtons.NextVerseButton",
  );
  ...
  const verseLimitOfChapter =
    ClientUtils.Islam.Quran.Verse.CountIndicator[chapterNumber - 1];
