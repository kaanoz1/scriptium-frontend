...
const VerseWordTable: React.FC<Props> = observer(({ words }) => {
  const t = useTranslations(
    "Pages.Islam.Quran.Chapter.Verse.Components.VerseWordTable",
  );
        ...
        <Table className="table-fixed w-full relative">
          <TableHeader className="sticky top-0 z-10 bg-card shadow-[0_1px_0_0_hsl(var(--border))]">
            <TableRow className="hover:bg-transparent">
              ...
              <TableHead className="w-[45%] text-right text-base">
                Text
              </TableHead>
          ...
          <TableBody>
            {words.map((word) => (
              ...
              >
                ...
                <TableCell
                  className={`text-right text-2xl font-medium break-words ${arabicFont.className}`}
                  dir="rtl"
                >
                  {word.text}
                </TableCell>
