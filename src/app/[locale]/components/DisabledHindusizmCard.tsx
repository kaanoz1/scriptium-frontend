...
const DisabledHinduismCard = () => {
    const t = useTranslations("Pages.Home.HinduismCard");
                        ...
                        <div className="opacity-60 grayscale cursor-help h-full">
                            <Card className="h-full border-dashed border-border/60 bg-muted/5 backdrop-blur-[2px] relative overflow-hidden transition-all hover:bg-muted/10">
                                <CardHeader>
                                    ...
                                    <CardDescription className="text-sm font-medium italic">{t("SanskritTitle")}</CardDescription>
                                </CardHeader>
...
export default DisabledHinduismCard;