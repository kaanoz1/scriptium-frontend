...
import { LuBook, LuLock } from "react-icons/lu";
...
const DisabledBibleCard = () => {
    const t = useTranslations("Pages.Home.BibleCard");
                        ...
                        <div className="opacity-60 grayscale cursor-help h-full">
                            <Card className="h-full border-dashed border-border/60 bg-muted/5 backdrop-blur-[2px] relative overflow-hidden transition-all hover:bg-muted/10">
                                <CardHeader>
                                    ...
                                    <CardDescription className="text-sm font-medium italic">{t("GreekTitle")}</CardDescription>
                                </CardHeader>
...
export default DisabledBibleCard;