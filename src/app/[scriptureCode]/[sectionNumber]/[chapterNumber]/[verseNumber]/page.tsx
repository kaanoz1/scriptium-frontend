                        ...
                        <div className="flex flex-row w-full pt-10 gap-10 ">
                            <div className="w-full flex-[3] ">
                                <div className="flex flex-col">
                                    <div
                                        className="flex flex-row gap-3 justify-center p-2 px-4 w-full rounded-t-lg border border-neutral-400/50 dark:border-gray-500 bg-gray-100 dark:bg-dark/70 text-gray-700 dark:text-gray-200">
                                        <div className="w-full flex justify-start">
                      <span
                          className="p-1 bg-gray-200/80 dark:bg-gray-950 text-gray-700 dark:text-gray-200 rounded-md inline-flex items-center gap-1">
                        <MdOutlineFormatListNumbered size={20}/> Words
                                    ...
                                    <div
                                        className="flex justify-center w-full py-1.5 px-2.5 border-x border-b border-neutral-300 dark:border-gray-600 bg-white dark:bg-dark">
                                        <div
                                            className="w-full flex justify-between items-center text-sm font-medium text-gray-600 dark:text-gray-300 dark:bg-dark">
