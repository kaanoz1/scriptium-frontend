...
import {
  CollectionWithVerseSavedInformation,
  T_CollectionWithVerseSavedInformationConstructorParametersJSON,
} from "@/types/classes/model/Collection/Collection";
import {
...
const fetchCollections = async (
  ...
  try {
    const response = await axiosCredentialInstance.get<
      Response<T_CollectionWithVerseSavedInformationConstructorParametersJSON[]>
    ...
    switch (response.status) {
      case OK_HTTP_RESPONSE_CODE:
        ...
        return response.data.data.map(
          CollectionWithVerseSavedInformation.createFromJSON
        );
...
const CollectionModal: NextPage<Props> = ({
  ...
  const saveVerseToCollection = async (verse: VerseBase) => {
