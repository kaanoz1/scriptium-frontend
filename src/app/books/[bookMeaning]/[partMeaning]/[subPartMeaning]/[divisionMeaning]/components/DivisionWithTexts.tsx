...
import TranslationIndicator from "./TranslationIndicatator";
import Text from "./BookText";
...
type Props = {
  divisionNode: BookNodeCoverThreeLevelUpperBookAndOneLevelLowerText;
};

const DivisionWithTexts: FC<Props> = ({ divisionNode }) => {
  ...
  const texts = divisionNode.getTexts();
